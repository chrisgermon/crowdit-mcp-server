...
COPY server_fast.py server.py azure_tools.py aws_tools.py email_tools.py calendar_tools.py jira_tools.py linear_tools.py notion_tools.py digitalocean_tools.py proxmox_tools.py ./
COPY app ./app
